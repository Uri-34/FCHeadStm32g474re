#ifndef STEP_DIR_ENGINE_H
#define STEP_DIR_ENGINE_H

#include <vector>

#include <DigitalOut.h>

#include "Head/Device/UARTDevice/UARTEngine/UARTEngine.h"

class UARTStepDirEngine : public UARTEngine 
{
public:
    enum Direction 
    {
...
public:
    UARTStepDirEngine(const string &name, const PinName &pin, uint8_t address) // , PinName tx, PinName rx, PinName step, PinName dir
        : UARTEngine(name, pin, address) 
        //   _txPin{tx}, 
        //   _rxPin{rx}, 
        //   _stepPin{step}, 
        //   _directionPin{dir}, 
