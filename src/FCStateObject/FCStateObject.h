...
*/
class FCStateObject 
    : public FCStateT<FCReadyState, FCErrorState>
{
private: 
    ...
    FCStateObject(const string &name, const uint32_t id = NoID, FCStateObject *parent = nullptr) 
        : FCStateT<FCReadyState, FCErrorState>(FCReadyState::NotReady, FCErrorState::None),
        _parent{parent},
        _name{name},
        _id{id}
    {}
